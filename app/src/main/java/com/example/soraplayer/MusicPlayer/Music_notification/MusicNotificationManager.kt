...
import com.example.soraplayer.MusicPlayer.Music_notification.MusicNotificationDescriptorAdapter
import com.example.soraplayer.R
import com.example.soraplayer.Utils.Constants
...
class MusicNotificationManager(
    ...
    private fun buildMusicNotification(mediaSession: MediaSession) {
        PlayerNotificationManager.Builder(
            ...
            .setSmallIconResourceId(R.drawable.music_note_24dp_e8eaed_fill0_wght400_grad0_opsz24)
            .build()
            .also {
